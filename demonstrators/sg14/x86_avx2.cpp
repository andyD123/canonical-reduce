...
//   -DNO_PAR_POLICIES=1
//
// Source: godbolt.org/z/jbYqf1Eez
// ============================================================================
...
static void reduce8_L16_sse2(const double* data, double* out) {
    ...
    for (size_t j = 0; j < L; j += 2) {
        ...
        __m128d sum01 = _mm_add_pd(v0, v1); __m128d sum23 = _mm_add_pd(v2, v3);
        __m128d sum45 = _mm_add_pd(v4, v5); __m128d sum67 = _mm_add_pd(v6, v7);
...
static void reduce8_L16_avx2(const double* data, double* out) {
    ...
    for (size_t j = 0; j < L; j += 4) {
        ...
        __m256d sum01 = _mm256_add_pd(v0, v1); __m256d sum23 = _mm256_add_pd(v2, v3);
        __m256d sum45 = _mm256_add_pd(v4, v5); __m256d sum67 = _mm256_add_pd(v6, v7);
...
static void reduce8_L16_avx512(const double* data, double* out) {
    ...
    for (size_t j = 0; j < L; j += 8) {
        ...
        __m512d sum01 = _mm512_add_pd(v0, v1); __m512d sum23 = _mm512_add_pd(v2, v3);
        __m512d sum45 = _mm512_add_pd(v4, v5); __m512d sum67 = _mm512_add_pd(v6, v7);
...
// ============================================================================
// Deterministic reduce (L=16 and L=128)
// ============================================================================
